...
打开你的站点地址（如 `https://hd-icons.pages.dev` 或你绑定的自定义域名），即可看到全部 2061+ 图标。无需任何额外同步步骤，图标已内置在项目中。
...
- [xushier/HD-Icons](https://github.com/xushier/HD-Icons) — 原始图标项目，提供了 2061+ 张高清仪表盘图标
